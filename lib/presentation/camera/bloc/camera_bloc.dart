...
class CameraBloc extends Bloc<CameraEvent, CameraState> {
  ...
  CameraBloc({required this.bluetoothPeripheralRepository}) : super(CameraState()) {
    on<CameraAppearEvent>(_startBluetoothPeripheralState);

  }

  void _startBluetoothPeripheralState(CameraAppearEvent event,
      Emitter<CameraState> emit) async {
        final didBluetoothStartStream = bluetoothPeripheralRepository.runBluetoothPeripheral();
